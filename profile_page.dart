...
class TelaPerfil extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
            ...
            body: Column(
                children: [
                    ...
                    Padding(
                        ...
                        child: Column(
                            children: [
                                buildListTile(const Color(0XFFA020F0), Icons.category_outlined),
                                const SizedBox(height: 16),
                                buildListTile(const Color(0XFFA020F0), Icons.construction_outlined),
                                const SizedBox(height: 16),
                                buildListTile(Colors.red, Icons.logout),
                                ],
                            ),
                        ),
                    ],
    ...
    buildListTile(Color c, IconData i) {
        return ListTile(
